...
if (isset($Email) && filter_var($Email, FILTER_VALIDATE_EMAIL)) {
    ...
    if (strlen($Email) > 1 && strpos($Email, '@') == true && strpos($Email, ".") == true) {
        ...
        $query = $MySQLi->query("SELECT * FROM mq_users WHERE email = '{$Email}'");
        if ($query->num_rows != 0) {
            $message = "
            <div>
...
<form name="Form1" method="post" id="Form1">
    ...
    <?php if (isset($_POST['textEmail']) && $fail == 0) { ?>
        <div id="panelSuccess" class="panelMsg" style="width:400px;text-align:center;">
            ...
            <h3>Check your inbox & spam folder for a new message with your list of <?php echo $sitename; ?> game
                accounts, and password reset instructions.</h3>
        </div>
    <?php } else { ?>
            ...
            <table id="Table1" cellspacing="0" cellpadding="10" width="100%" style="border-style: none" align="center">
                <tr>
                    <td align="center" colspan="2" class="tblHeader">
                        <h3>Enter the email you registered for your <?php echo $sitename; ?> game account, and we will
                            send you an email
                ...
                <tr class="tblGrey">
                    ...
                    <td width="160">
                        <input name="textEmail" type="text" id="textEmail" class="stdInput"
                               placeholder="youremail@somewhere.com" style="width:220px;"/></td>
                </tr>
                <tr class="tblGrey" align="center">
                    <td colspan="2">
                        <input type="submit" name="btnLogin" value="Get My Account Information" id="btnLogin"
                               class="stdButton"/>
                        <br/>
                        <br/>
                    </td>
